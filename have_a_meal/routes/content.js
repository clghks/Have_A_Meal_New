...
var hotContentList = [
    ...
    { id : 4, userId: 'chchoi@gmail.com', isPublicity: true, recruitStartDateTime: new Date(2014,3,24), recruitEndDateTime: new Date, foodType: 1, subject: '테로 16회 쉐프와 흑돼지 미담 함께 먹으러 가요', contents: '둘이 먹긴 너무 아쉬운 맛집 탐방입니다\n맛집에 갈 때마다 "아, 여길 여러명이 왔으면 더 많은 메뉴를 먹었을 텐데"하며 아쉬운 적 많이 있으시죠?', gpsX:1000.00, gpsY:2222.00, meetingDateTime: new Date, count: 10, fee: 20000, joinUsers: 'aaaaa', attachedFile: 'hi~~', imgUrl:'http://www.zipbob.net/uploads/dining/photo/image/db/33/53bbc370e76f68efc6000006/large_%EB%AF%B8%EB%9E%98%EC%86%8C%EB%85%84.jpg'},
    { id : 5, userId: 'chchoi@gmail.com', isPublicity: true, recruitStartDateTime: new Date(2014,3,24), recruitEndDateTime: new Date, foodType: 1, subject: '테로 16회 쉐프와 흑돼지 미담 함께 먹으러 가요', contents: '둘이 먹긴 너무 아쉬운 맛집 탐방입니다\n맛집에 갈 때마다 "아, 여길 여러명이 왔으면 더 많은 메뉴를 먹었을 텐데"하며 아쉬운 적 많이 있으시죠?', gpsX:1000.00, gpsY:2222.00, meetingDateTime: new Date, count: 10, fee: 20000, joinUsers: 'aaaaa', attachedFile: 'hi~~', imgUrl:'http://www.zipbob.net/uploads/dining/photo/image/db/33/53bbc370e76f68efc6000006/large_%EB%AF%B8%EB%9E%98%EC%86%8C%EB%85%84.jpg'},
];
